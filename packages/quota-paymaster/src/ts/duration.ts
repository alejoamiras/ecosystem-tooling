/**
 * Human durations for user-facing copy.
 *
 * "resets in 3 hours" is something a user can act on. A timestamp, a countdown
 * to the second, or "00:00 UTC" all make them do arithmetic to answer the only
 * question they actually have: is it worth waiting?
 */
 ...
 * which invites a user to sit and watch a number.
 */
